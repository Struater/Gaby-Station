...
# head
modsuit-module-medhud-name = { ent-ModsuitModuleMedhud }
modsuit-module-diagnostichud-name = { ent-ModsuitModuleDiagnosticHud }
modsuit-module-sechud-name = { ent-ModsuitModuleSecHud }
modsuit-module-welding-name = { ent-ModsuitModuleWelding }
